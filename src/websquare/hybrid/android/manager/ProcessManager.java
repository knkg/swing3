...
public class ProcessManager extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int main = this.getResources().getIdentifier("manager_layout", "layout", this.getPackageName());
		int available_mem_label = this.getResources().getIdentifier("available_mem_label", "id", this.getPackageName());
		int num_processes_label = this.getResources().getIdentifier("num_processes_label", "id", this.getPackageName());
		setContentView(main);
		...
		int processinfo = this.getResources().getIdentifier("processinfo", "drawable", this.getPackageName());
		
		pk = getPackageManager();
		
		availMem_label = (TextView)findViewById(available_mem_label);
		numProc_label = (TextView)findViewById(num_processes_label);
	...
	private class MyListAdapter extends ArrayAdapter<RunningAppProcessInfo> {
		...
		public MyListAdapter() {
			super(ProcessManager.this, tablerow, display_process);
		}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(view == null) {
				...
				view = inflater.inflate(tablerow, parent, false);
			}
			
			TextView bottom_label = (TextView)view.findViewById(bottom_view);
			TextView top_label = (TextView)view.findViewById(top_view);
			ImageView icon = (ImageView)view.findViewById(row_image);
			...
			try {
				...
				icon.setImageResource(processinfo);
			}
			return view;			
		}
	}
