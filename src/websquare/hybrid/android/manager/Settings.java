...
public class Settings extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		int main = this.getResources().getIdentifier("manager_settings", "layout", this.getPackageName());
		int setting_hidden_box = this.getResources().getIdentifier("setting_hidden_box", "id", this.getPackageName());
		int setting_thumbnail_box = this.getResources().getIdentifier("setting_thumbnail_box", "id", this.getPackageName());
		int setting_storage_box = this.getResources().getIdentifier("setting_storage_box", "id", this.getPackageName());
		int setting_text_color_button = this.getResources().getIdentifier("setting_text_color_button", "id", this.getPackageName());
		int settings_sort_button = this.getResources().getIdentifier("settings_sort_button", "id", this.getPackageName());
		setContentView(main);
		...
		final CheckBox hidden_bx = (CheckBox)findViewById(setting_hidden_box);
		final CheckBox thumbnail_bx = (CheckBox)findViewById(setting_thumbnail_box);
		final CheckBox space_bx = (CheckBox)findViewById(setting_storage_box);
		final ImageButton color_bt = (ImageButton)findViewById(setting_text_color_button);
		final ImageButton sort_bt = (ImageButton)findViewById(settings_sort_button);
		
		hidden_bx.setChecked(hidden_state);
		thumbnail_bx.setChecked(thumbnail_state);
		space_bx.setChecked(mSpaceState == View.VISIBLE);
		
		final int color = this.getResources().getIdentifier("color", "drawable", this.getPackageName());
		final int filter = this.getResources().getIdentifier("filter", "drawable", this.getPackageName());
