...
public final class Main extends ListActivity {
	public static final String ACTION_WIDGET = "websquare.hybrid.android.manager.Main.ACTION_WIDGET";
	...
	int newfolder, search, setting, logout;
	int warning, rename;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int main = this.getResources().getIdentifier("manager_main", "layout", this.getPackageName());
		int storage_label = this.getResources().getIdentifier("storage_label", "id", this.getPackageName());
		int detail_label = this.getResources().getIdentifier("detail_label", "id", this.getPackageName());
		int path_label = this.getResources().getIdentifier("path_label", "id", this.getPackageName());
		
		int help_button = this.getResources().getIdentifier("help_button", "id", this.getPackageName());
		int home_button = this.getResources().getIdentifier("home_button", "id", this.getPackageName());
		int back_button = this.getResources().getIdentifier("back_button", "id", this.getPackageName());
		int info_button = this.getResources().getIdentifier("info_button", "id", this.getPackageName());
		int manage_button = this.getResources().getIdentifier("manage_button", "id", this.getPackageName());
		int multiselect_button = this.getResources().getIdentifier("multiselect_button", "id", this.getPackageName());
		
		int hidden_copy = this.getResources().getIdentifier("hidden_copy", "id", this.getPackageName());
		int hidden_attach = this.getResources().getIdentifier("hidden_attach", "id", this.getPackageName());
		int hidden_delete = this.getResources().getIdentifier("hidden_delete", "id", this.getPackageName());
		int hidden_move = this.getResources().getIdentifier("hidden_move", "id", this.getPackageName());
		
		int back = this.getResources().getIdentifier("back", "drawable", this.getPackageName());
		int home = this.getResources().getIdentifier("home", "drawable", this.getPackageName());
		int toolbox = this.getResources().getIdentifier("toolbox", "drawable", this.getPackageName());
		int multiselect_38 = this.getResources().getIdentifier("multiselect_38", "drawable", this.getPackageName());
		int info = this.getResources().getIdentifier("info", "drawable", this.getPackageName());
		int help = this.getResources().getIdentifier("help", "drawable", this.getPackageName());
		
		setContentView(main);
		
		newfolder = this.getResources().getIdentifier("newfolder", "drawable", this.getPackageName());
		search = this.getResources().getIdentifier("search", "drawable", this.getPackageName());
		setting = this.getResources().getIdentifier("setting", "drawable", this.getPackageName());
		logout = this.getResources().getIdentifier("logout", "drawable", this.getPackageName());
		warning = this.getResources().getIdentifier("warning", "drawable", this.getPackageName());
		rename = this.getResources().getIdentifier("rename", "drawable", this.getPackageName());
        ...
        mStorageLabel = (TextView)findViewById(storage_label);
        mDetailLabel = (TextView)findViewById(detail_label);
        ...
        /* setup buttons */
        int[] img_button_id = {help_button, home_button, 
        					   back_button, info_button, 
        					   manage_button, multiselect_button};
        
        int[] button_id = {hidden_copy, hidden_attach,
        				   hidden_delete, hidden_move};
        ...
        for(int i = 0; i < img_button_id.length; i++) {
        	...
        	if(i==0)bimg[i].setImageResource(help);
        	else if(i==1)bimg[i].setImageResource(home);
        	else if(i==2)bimg[i].setImageResource(back);
        	else if(i==3)bimg[i].setImageResource(info);
        	else if(i==4)bimg[i].setImageResource(toolbox);
        	else if(i==5)bimg[i].setImageResource(multiselect_38);
	...
	private void returnIntentResults(File data) {
		...
		File fileSelected = new File(data.getPath());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	menu.add(0, MENU_MKDIR, 0, "New Directory").setIcon(newfolder);
    	menu.add(0, MENU_SEARCH, 0, "Search").setIcon(search);
    	
    		/* free space will be implemented at a later time */
//    	menu.add(0, MENU_SPACE, 0, "Free space").setIcon(R.drawable.space);
    	menu.add(0, MENU_SETTING, 0, "Settings").setIcon(setting);
    	menu.add(0, MENU_QUIT, 0, "Quit").setIcon(logout);
    ...
    protected Dialog onCreateDialog(int id) {
    	...
    	int main = this.getResources().getIdentifier("manager_input_layout", "layout", this.getPackageName());
		int input_icon = this.getResources().getIdentifier("input_icon", "id", this.getPackageName());
		int input_label = this.getResources().getIdentifier("input_label", "id", this.getPackageName());
		int input_inputText = this.getResources().getIdentifier("input_inputText", "id", this.getPackageName());
		int input_cancel_b = this.getResources().getIdentifier("input_cancel_b", "id", this.getPackageName());
		int input_create_b = this.getResources().getIdentifier("input_create_b", "id", this.getPackageName());
    	...
    	switch(id) {
    		case MENU_MKDIR:
    			...
    			ImageView icon = (ImageView)dialog.findViewById(input_icon);
    			icon.setImageResource(newfolder);
    			
    			TextView label = (TextView)dialog.findViewById(input_label);
    			label.setText(mFileMag.getCurrentDir());
    			final EditText input = (EditText)dialog.findViewById(input_inputText);
    			
    			Button cancel = (Button)dialog.findViewById(input_cancel_b);
    			Button create = (Button)dialog.findViewById(input_create_b);
    		...
    		case F_MENU_RENAME:
    			...
    			ImageView rename_icon = (ImageView)dialog.findViewById(input_icon);
    			rename_icon.setImageResource(rename);
    			
    			TextView rename_label = (TextView)dialog.findViewById(input_label);
    			rename_label.setText(mFileMag.getCurrentDir());
    			final EditText rename_input = (EditText)dialog.findViewById(input_inputText);
    			
    			Button rename_cancel = (Button)dialog.findViewById(input_cancel_b);
    			Button rename_create = (Button)dialog.findViewById(input_create_b);
    		...
    		case MENU_SEARCH:
    			...
    			ImageView searchIcon = (ImageView)dialog.findViewById(input_icon);
    			searchIcon.setImageResource(search);
    			
    			TextView search_label = (TextView)dialog.findViewById(input_label);
    			search_label.setText("Search for a file");
    			final EditText search_input = (EditText)dialog.findViewById(input_inputText);
    			
    			Button search_button = (Button)dialog.findViewById(input_create_b);
    			Button cancel_button = (Button)dialog.findViewById(input_cancel_b);
